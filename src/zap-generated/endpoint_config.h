...
\
  ...
  { (uint16_t)0x3, (uint16_t)0x0, (uint16_t)0x5 }, /* ControlSequenceOfOperation */ \
  { (uint16_t)0x4, (uint16_t)0x0, (uint16_t)0x7 } /* SystemMode */ \
}
...
\
  ...
  { ZAP_MIN_MAX_DEFAULTS_INDEX(0), 0x00000012, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* OccupiedHeatingSetpoint */  \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(1), 0x00000015, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinHeatSetpointLimit */  \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(2), 0x00000016, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MaxHeatSetpointLimit */  \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x0000001B, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ControlSequenceOfOperation */  \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(4), 0x0000001C, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* SystemMode */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 15, 120 }, \
  { ZAP_CLUSTER_INDEX(15), 7, 48 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x0301,2}}
